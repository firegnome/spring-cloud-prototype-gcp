...
SET microservice=statistic-microservice
SET jarfile=build/libs/statisticmicroservice-0.0.1-SNAPSHOT.jar
...
CALL kubectl create secret generic statistic-secret --from-file=credentials.json=%microservice%-credentials.json
